...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    <html lang="zh-CN" suppressHydrationWarning>
      <head><meta name="theme-color" content="#eef0f7" data-reshi-theme="" /></head>
      <body>
        <script dangerouslySetInnerHTML={{ __html: themeScript }} />
        <NoticeBanner />
        {/* eslint-disable @next/next/no-img-element */}
        <img className="site-mascot" src="/site-mascot.webp" alt="" width={1069} height={1471} fetchPriority="high" decoding="async" aria-hidden="true" />
