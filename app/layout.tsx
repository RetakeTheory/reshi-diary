...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang="zh-CN" suppressHydrationWarning><body><script dangerouslySetInnerHTML={{ __html: themeScript }} /><NoticeBanner /><div className="site-mascot" aria-hidden="true" />{children}<ThemeControls /></body></html>;
}
